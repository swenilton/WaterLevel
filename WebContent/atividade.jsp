...
<title>Atividade - Water Level</title>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="active"><a href="atividade.html">Atividade</a></li>
...
<div class="container">    
  <div class="conteudo">        
    <div class="page-header page-titulo">
        ...
        <!-- titulo -->
        <h1>Atividade <small>Gerenciamento</small></h1>
    </div><!-- fim page-header -->
    <div class="panel panel-default panel-user">
      ...
      <div class="table-responsive table-user">
        <table class="table table-hover">
          <caption class="hidden">Lista de Atividades</caption>
          <thead>
            <tr>
                <th>#</th>
                <th>ID</th>
          ...
          <tbody>
            ...
            <tr>
                <th width="40px"><input type="radio" name="user-selected" value="2"/></th>            
                <td width="60px">2</td>
                <td>Tomar banho</td>
            </tr>
            <tr>
                <th width="40px"><input type="radio" name="user-selected" value="3"/></th>            
                <td width="60px">3</td>
                <td>Lavar os pratos</td>
            </tr>
            <tr>
                <th width="40px"><input type="radio" name="user-selected" value="4"/></th>            
                <td width="60px">4</td>
                <td>Lavar as roupas</td>
            </tr>
          </tbody>
        </table>
      </div><!-- fim div  table -->  
    ...
    <div class="btn-group" role="group" aria-label="">
      <a class="btn btn-default" href="atividade-inserir.html" role="button">Inserir</a>
      <button type="button" class="btn btn-default" data-toggle="modal" data-target="#alterar-atividade">Alterar</button>
      <button type="button" class="btn btn-default">Remover</button>
    </div>      
  </div><!-- fim conteudo -->
</div><!-- fim container -->
<!-- Modal Alterar atividade -->
<div class="modal fade" id="alterar-atividade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <form class="">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nome" placeholder="Ex: Tomar banho"/>
          </div>
        </form>
      </div>
      <div class="modal-footer">
