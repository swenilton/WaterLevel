      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="active"><a href="repositorio.html">Repositório</a></li>
...
<div class="container">    
  <div class="conteudo">        
    <div class="page-header page-titulo">
        ...
        <!-- titulo -->
        <h1>Repositório <small>Inserir</small></h1>
    </div><!-- fim page-header -->
    <div class="row">
      <div class="col-md-6">
        <img class="img-responsive" src="img/caixa-800px.png" alt="Foto caixa de água"/>
      </div>
      <div class="col-md-6">
        <form>
