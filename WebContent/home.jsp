...
function geraCaixa1(){
    ...
    document.getElementById("progress").innerHTML = "<h1>" + skillVal + "</h1>";
    $(skillBar).animate({
        height: skillVal
    }, 1000);
}
...
function geraCaixa2(){
    ...
    var skillVal = Math.floor((Math.random() * 100) + 1) + "%";
    document.getElementById("progress2").innerHTML = "<h1>" + skillVal + "</h1>";
    $(skillBar).animate({
        height: skillVal
    }, 1000);
}
...
<div class="container">    
  <div class="conteudo">        
      <div class="page-header page-titulo">
          ...
          <!-- titulo -->
          <h1>Resumo Diário <small>Monitoramento</small></h1>
      </div>
      <!-- abas -->
      <ul class="nav nav-tabs grupo-abas">
        <li role="presentation" class="active"><a href="#caixa1" data-toggle="tab" aria-controls="caixa1" role="tab">Caixa 1</a></li>
        <li role="presentation"><a href="#caixa2" data-toggle="tab" aria-controls="caixa2" role="tab">Caixa 2</a></li>
      </ul>
              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class='skill' id="caixa1">
                          ...
                          <div id='caixa'>
                              <img src='img/caixa-800px.png' class="img-responsive" alt="Imagem ilustrativa do nivél de água"/>            
                          </div>
                      </div> <!-- fim skill -->
                  </div>
                  <div class="col-md-6">
                      ...
                      <div class="panel panel-default bomba">
                          <div class="panel-heading">
                              ...
                              <ul class="nav nav-pills pull-right" id="tab">
                                <li role="presentation" class="active"><a href="#auto" data-toggle="pill" aria-controls="auto" role="tab">Automático</a></li>
                                <li role="presentation"><a href="#manual" data-toggle="pill" aria-controls="manual" role="tab">Manual</a></li>  
                              </ul>
                          </div>
                          <div class="tab-content">
                              <div role="tabpanel" class="tab-pane fade in active" id="auto">
                                  <form class="form-inline">
                                      <div class="form-group form-grupo">
                                          <label for="limite-max">Limite Max</label>
                                          <input type="text" class="form-control" id="limite-max" placeholder="Litros">
                                      </div>
                                      <div class="form-group form-grupo">
                                          <label for="limite-min">Limite Min </label>
                                          <input type="text" class="form-control" id="limite-min" placeholder="Litros">
                                      </div>
                              ...
                              <div role="tabpanel" class="tab-pane fade" id="manual">
                                  <form class="form-inline">
                                      ...
                                      <button type="button" class="btn btn-danger btn-salvar" id="liga">Ligar Bomba</button>                   
                                  </form>
                              </div>
                          </div>
                      </div><!-- fim painel bomba -->
                  </div><!-- fim coluna -->
              </div><!-- fim row -->
          </section><!-- fim section caixa -->
        </div><!-- fim tab1 -->
      ...
      <section class="ultimas-atividades">
        <div class="row">
          <div class="col-md-6">
            <div class="page-header page-titulo">
              <!-- titulo -->
              <h2>Últimas Atividades <small>Resumo</small></h2>
            </div>
            ...
            </div><!-- fim painel atividades -->
          </div><!-- fim coluna -->
          <div class="col-md-6">
            <div class="page-header page-titulo">
              <!-- titulo -->
              <h2>Últimos Acionamentos <small>Resumo</small></h2>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">
